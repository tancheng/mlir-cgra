...
# perform tiling
soda-opt --linalg-tiling-for-cgra=cgra-configs=4,4,1024,1024,1024,1024 04-finalized.mlir > 05-tiled-4.mlir

# locating target operations that will be offloaded onto CGRA
soda-opt --convert-linalg-matmul-to-cgra --convert-linalg-batch_matmul-to-cgra --convert-linalg-generic-to-cgra 05-tiled-4.mlir > 06-locating-4.mlir
