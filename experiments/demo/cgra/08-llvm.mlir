module attributes {llvm.data_layout = "", llvm.target_triple = "x86_64-unknown-linux-gnu", soda.container_module} {
  ...
  ^bb18:  // pred: ^bb17
    ...
    llvm.call @cgra_fusion_add_max_add(%115, %122, %247, %253, %249, %254, %250, %258, %260, %268, %274, %270, %275, %271, %279, %281, %289, %295, %291, %296, %292, %220, %227, %305, %311, %307, %312, %308) : (!llvm.ptr<f32>, !llvm.ptr<f32>, i64, i64, i64, i64, i64, !llvm.ptr<f32>, !llvm.ptr<f32>, i64, i64, i64, i64, i64, !llvm.ptr<f32>, !llvm.ptr<f32>, i64, i64, i64, i64, i64, !llvm.ptr<f32>, !llvm.ptr<f32>, i64, i64, i64, i64, i64) -> ()
