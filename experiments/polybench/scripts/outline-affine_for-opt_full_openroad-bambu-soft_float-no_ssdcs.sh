...
# Directories
WORKDIR=$(pwd)
ODIR=${KERNELDIR}/output-${DEVICE}-1G/${KERNEL}/opt_full_openroad-soft_float-no_ssdcs
BAMBUDIR=${ODIR}/bambu
...
LIST1=(
  ...
  ${SCRIPTDIR}/outline-affine_for-opt_full_openroad-bambu-soft_float-no_ssdcs.sh
