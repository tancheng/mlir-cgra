...
module attributes {soda.container_module, tf.versions = {bad_consumers = [], min_consumer = 0 : i32, producer = 1087 : i32}} {
  ...
  func.func @main(%arg0: memref<4x32x32x1xf32>, %arg1: memref<4x2xf32>) attributes {tf.entry_function = {control_outputs = "", inputs = "x1", outputs = "Identity"}} {
    ...
    soda.launch_func  @main_kernel::@main_kernel args(%24 : memref<1x4x8xf32>, %4 : memref<1x8x4xf32>, %26 : memref<1x4x4xf32>)
...
module attributes {soda.bambu.container_module, soda.container_module, tf.versions = {bad_consumers = [], min_consumer = 0 : i32, producer = 1087 : i32}} {
  func.func @main_kernel(%arg0: memref<1x4x8xf32>, %arg1: memref<1x8x4xf32>, %arg2: memref<1x4x4xf32>) {
    cf.br ^bb1
  ^bb1:  // pred: ^bb0
    linalg.batch_matmul ins(%arg0, %arg1 : memref<1x4x8xf32>, memref<1x8x4xf32>) outs(%arg2 : memref<1x4x4xf32>)
    return
...
module attributes {soda.bambu.container_module, soda.container_module, tf.versions = {bad_consumers = [], min_consumer = 0 : i32, producer = 1087 : i32}} {
  ...
  ^bb4:  // pred: ^bb3
    %14 = memref.load %arg0[%4, %5, %11] : memref<1x4x8xf32>
    %15 = memref.load %arg1[%4, %11, %8] : memref<1x8x4xf32>
    %16 = memref.load %arg2[%4, %5, %8] : memref<1x4x4xf32>
    %17 = llvm.fmul %14, %15  : f32
    %18 = llvm.fadd %16, %17  : f32
    memref.store %18, %arg2[%4, %5, %8] : memref<1x4x4xf32>
    %19 = llvm.add %12, %2  : i64
...
module attributes {soda.bambu.container_module, soda.container_module, tf.versions = {bad_consumers = [], min_consumer = 0 : i32, producer = 1087 : i32}} {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %51 = llvm.mul %6, %50  : i64
    %52 = llvm.mlir.constant(4 : index) : i64
    %53 = llvm.mul %9, %52  : i64
...
module attributes {llvm.data_layout = "", soda.bambu.container_module, soda.container_module, tf.versions = {bad_consumers = [], min_consumer = 0 : i32, producer = 1087 : i32}} {
  ...
  ^bb1(%62: i64):  // 2 preds: ^bb0, ^bb6
    ...
    %66 = llvm.icmp "slt" %65, %58 : i64
    llvm.cond_br %66, ^bb2(%60 : i64), ^bb7
  ^bb2(%67: i64):  // 2 preds: ^bb1, ^bb5
    ...
    %71 = llvm.icmp "slt" %70, %58 : i64
    llvm.cond_br %71, ^bb3(%60 : i64), ^bb6
