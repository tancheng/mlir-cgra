...
static LogicalResult convertLinalgGenericToCGRALaunch(linalg::GenericOp op) {
...
LogicalResult mlir::convertLinalgGenericToCGRALaunch(linalg::GenericOp op) {
  return ::convertLinalgGenericToCGRALaunch(op);
}
