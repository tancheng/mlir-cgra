...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @main_graph(%arg0: memref<16x32xf32>, %arg1: memref<32x16xf32>, %arg2: memref<16x16xf32>, %arg3: memref<16x16xf32>, %arg4: memref<16x16xf32>) attributes {input_names = ["X0", "X1", "X2", "X3"], output_names = ["Z0"]} {
    ...
    scf.for %arg5 = %c0 to %c16 step %c4 {
      %3 = memref.subview %0[%arg5, 0] [4, 16] [1, 1] : memref<16x16xf32> to memref<4x16xf32, #map0>
      linalg.fill ins(%cst : f32) outs(%3 : memref<4x16xf32, #map0>)
    }
    ...
    scf.for %arg5 = %c0 to %c16 step %c4 {
      ...
      %4 = memref.subview %1[%arg5, 0] [4, 16] [1, 1] : memref<16x16xf32> to memref<4x16xf32, #map0>
      linalg.matmul ins(%3, %arg1 : memref<4x32xf32, #map1>, memref<32x16xf32>) outs(%4 : memref<4x16xf32, #map0>)
    }
    %2 = memref.alloc() {alignment = 128 : i64} : memref<16x16xf32>
    scf.for %arg5 = %c0 to %c16 step %c4 {
      %3 = memref.subview %1[%arg5, 0] [4, 16] [1, 1] : memref<16x16xf32> to memref<4x16xf32, #map0>
      %4 = memref.subview %arg2[%arg5, 0] [4, 16] [1, 1] : memref<16x16xf32> to memref<4x16xf32, #map0>
      %5 = memref.subview %arg3[%arg5, 0] [4, 16] [1, 1] : memref<16x16xf32> to memref<4x16xf32, #map0>
      %6 = memref.subview %2[%arg5, 0] [4, 16] [1, 1] : memref<16x16xf32> to memref<4x16xf32, #map0>
      linalg.generic {indexing_maps = [#map2, #map2, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%3, %4, %5 : memref<4x16xf32, #map0>, memref<4x16xf32, #map0>, memref<4x16xf32, #map0>) outs(%6 : memref<4x16xf32, #map0>) {
