  ...
  func.func @main_graph(%arg0: memref<16x32xf32>, %arg1: memref<32x16xf32>, %arg2: memref<16x16xf32>, %arg3: memref<16x16xf32>, %arg4: memref<16x16xf32>) attributes {input_names = ["X0", "X1", "X2", "X3"], output_names = ["Z0"]} {
    ...
    scf.for %arg5 = %c0 to %c16 step %c4 {
      scf.for %arg6 = %c0 to %c16 step %c8 {
        ...
        linalg.matmul ins(%3, %4 : memref<4x32xf32, #map1>, memref<32x8xf32, #map0>) outs(%5 : memref<4x8xf32, #map0>)
      }
    }
    ...
    scf.for %arg5 = %c0 to %c16 step %c4 {
      scf.for %arg6 = %c0 to %c16 step %c8 {
        ...
        linalg.generic {indexing_maps = [#map2, #map2, #map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%3, %4, %5 : memref<4x8xf32, #map0>, memref<4x8xf32, #map0>, memref<4x8xf32, #map0>) outs(%6 : memref<4x8xf32, #map0>) {
