...
define void @main(float* %0, float* %1, i64 %2, i64 %3, i64 %4, float* %5, float* %6, i64 %7, i64 %8, i64 %9, float* %10, float* %11, i64 %12) {
  ...
  %27 = alloca float, i64 mul (i64 ptrtoint (float* getelementptr (float, float* null, i32 1) to i64), i64 32), align 4
  ...
  %33 = alloca float, i64 mul (i64 ptrtoint (float* getelementptr (float, float* null, i32 1) to i64), i64 32), align 4
  ...
  %39 = alloca float, i64 ptrtoint (float* getelementptr (float, float* null, i64 1) to i64), align 4
...
; CHECK: !annotation ![[A1:.*]]
; CHECK: !annotation ![[A2:.*]]
; CHECK: ![[A0]] = !{!"alloca_main0"}
; CHECK: ![[A1]] = !{!"alloca_main1"}
; CHECK: ![[A2]] = !{!"alloca_main2"}
