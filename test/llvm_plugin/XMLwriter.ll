...
define void @main(float* %0, float* %1, i64 %2, i64 %3, i64 %4, float* %5, float* %6, i64 %7, i64 %8, i64 %9, float* %10, float* %11, i64 %12) !dbg !3 {
  ...
  %37 = insertvalue { float*, float*, i64, [1 x i64], [1 x i64] } %36, i64 32, 3, 0, !dbg !33
  %38 = insertvalue { float*, float*, i64, [1 x i64], [1 x i64] } %37, i64 1, 4, 0, !dbg !34
  %39 = alloca float, i64 ptrtoint (float* getelementptr (float, float* null, i64 1) to i64), align 4, !dbg !35, !annotation !36
  %40 = insertvalue { float*, float*, i64 } undef, float* %39, 0, !dbg !37
  %41 = insertvalue { float*, float*, i64 } %40, float* %39, 1, !dbg !38
  %42 = insertvalue { float*, float*, i64 } %41, i64 0, 2, !dbg !39
  %43 = extractvalue { float*, float*, i64 } %26, 1, !dbg !40
  %44 = load float, float* %43, align 4, !dbg !41
  %45 = extractvalue { float*, float*, i64 } %42, 1, !dbg !42
  store float %44, float* %45, align 4, !dbg !43
  br label %46, !dbg !44

46:                                               ; preds = %49, %13
  %47 = phi i64 [ %60, %49 ], [ 0, %13 ]
  %48 = icmp slt i64 %47, 32, !dbg !45
  br i1 %48, label %49, label %61, !dbg !46

49:                                               ; preds = %46
  %50 = extractvalue { float*, float*, i64, [1 x i64], [1 x i64] } %18, 1, !dbg !47
  %51 = getelementptr float, float* %50, i64 %47, !dbg !48
  %52 = load float, float* %51, align 4, !dbg !49
  %53 = extractvalue { float*, float*, i64, [1 x i64], [1 x i64] } %32, 1, !dbg !50
  %54 = getelementptr float, float* %53, i64 %47, !dbg !51
  store float %52, float* %54, align 4, !dbg !52
  %55 = extractvalue { float*, float*, i64, [1 x i64], [1 x i64] } %23, 1, !dbg !53
  %56 = getelementptr float, float* %55, i64 %47, !dbg !54
  %57 = load float, float* %56, align 4, !dbg !55
  %58 = extractvalue { float*, float*, i64, [1 x i64], [1 x i64] } %38, 1, !dbg !56
  %59 = getelementptr float, float* %58, i64 %47, !dbg !57
  store float %57, float* %59, align 4, !dbg !58
  %60 = add i64 %47, 1, !dbg !59
  br label %46, !dbg !60
...
62:                                               ; preds = %65, %61
  ...
  %64 = icmp slt i64 %63, 32, !dbg !62
  br i1 %64, label %65, label %78, !dbg !63

65:                                               ; preds = %62
  %66 = extractvalue { float*, float*, i64, [1 x i64], [1 x i64] } %32, 1, !dbg !64
  %67 = getelementptr float, float* %66, i64 %63, !dbg !65
  %68 = load float, float* %67, align 4, !dbg !66
  %69 = extractvalue { float*, float*, i64, [1 x i64], [1 x i64] } %38, 1, !dbg !67
  %70 = getelementptr float, float* %69, i64 %63, !dbg !68
  %71 = load float, float* %70, align 4, !dbg !69
  %72 = extractvalue { float*, float*, i64 } %42, 1, !dbg !70
  %73 = load float, float* %72, align 4, !dbg !71
  %74 = fmul float %68, %71, !dbg !72
  %75 = fadd float %73, %74, !dbg !73
  %76 = extractvalue { float*, float*, i64 } %42, 1, !dbg !74
  store float %75, float* %76, align 4, !dbg !75
  %77 = add i64 %63, 1, !dbg !76
  br label %62, !dbg !77

78:                                               ; preds = %62
  %79 = extractvalue { float*, float*, i64 } %42, 1, !dbg !78
  %80 = load float, float* %79, align 4, !dbg !79
  %81 = extractvalue { float*, float*, i64 } %26, 1, !dbg !80
  store float %80, float* %81, align 4, !dbg !81
  ret void, !dbg !82
}
...
!52 = !DILocation(line: 72, column: 5, scope: !8)
...
!58 = !DILocation(line: 78, column: 5, scope: !8)
!59 = !DILocation(line: 79, column: 11, scope: !8)
!60 = !DILocation(line: 80, column: 5, scope: !8)
!61 = !DILocation(line: 85, column: 5, scope: !8)
!62 = !DILocation(line: 87, column: 11, scope: !8)
!63 = !DILocation(line: 88, column: 5, scope: !8)
