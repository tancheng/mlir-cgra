...
// RUN: soda-opt %s -forward-memref-allocations -forward-linalg-fill -forward-linalg-copy -forward-memref-allocations | FileCheck %s --check-prefix=F_A_F_C_A
...
func @forward_allocations() {
  ...
  linalg.fill(%cst, %4) : f32, memref<1x7x7x32xf32> 
  linalg.copy(%4, %5) : memref<1x7x7x32xf32>, memref<1x7x7x32xf32> 
  return
}

// FFILL-LABEL: func @forward_allocations 
...
// FFILL-NEXT:  linalg.fill(%cst, %4) : f32, memref<1x7x7x32xf32> 
// FFILL-NEXT:  %5 = memref.alloc() : memref<1x7x7x32xf32>
// FFILL-NEXT:  linalg.copy(%4, %5) : memref<1x7x7x32xf32>, memref<1x7x7x32xf32> 


// F_A_F-LABEL: func @forward_allocations 
...
// F_A_F-NEXT:  linalg.fill(%cst, %3) : f32, memref<1x7x7x32xf32> 
...
// F_A_F-NEXT:  linalg.copy(%3, %4) : memref<1x7x7x32xf32>, memref<1x7x7x32xf32> 

// F_A_F_C_A-LABEL: func @forward_allocations 
...
// F_A_F_C_A-NEXT:    linalg.fill(%cst, %3) : f32, memref<1x7x7x32xf32> 
// F_A_F_C_A-NEXT:    linalg.copy(%3, %4) : memref<1x7x7x32xf32>, memref<1x7x7x32xf32> 
